  ...
  return (
    <html lang="en" className="dark">
      <head>
        ...
        <Script id="google-tag-manager" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-TNZCZTD8');
          `}
        </Script>
      ...
      >
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TNZCZTD8"
            height="0"
            width="0"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=1646810336901482&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
