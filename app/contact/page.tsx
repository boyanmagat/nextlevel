                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-2">
                            ...
                            <input type="text" className="w-full bg-black/50 border border-white/10 rounded-lg p-4 focus:border-pink-500 focus:outline-none transition-colors text-white" placeholder="John Doe" />
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-gray-500 uppercase tracking-wider">Email</label>
                            <input type="email" className="w-full bg-black/50 border border-white/10 rounded-lg p-4 focus:border-pink-500 focus:outline-none transition-colors text-white" placeholder="john@example.com" />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea className="w-full h-40 bg-black/50 border border-white/10 rounded-lg p-4 focus:border-pink-500 focus:outline-none transition-colors text-white" placeholder="Tell us about your project..."></textarea>
                    </div>

                    <button type="submit" className="w-full bg-white text-black font-bold text-xl py-4 rounded-lg hover:scale-[1.02] active:scale-[0.98] transition-transform">
                        Send Inquiry
                    </button>
                </motion.form>
